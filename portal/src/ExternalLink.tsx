...
export default function ExternalLink(props: ExternalLinkProps): ReactElement {
  // color="indigo" forces the accent color so the link stays a link even when
  // nested inside a gray <Text> (which otherwise reassigns the accent scale to
  // gray for its descendants, rendering the link gray/black instead of blue).
